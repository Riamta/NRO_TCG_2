...
public class BossID {
    ...
    public static final int ROBOT_VE_SI = -8;
     public static final int GOTENKS = -72882;

      public static final int GOTENKS_CLONE = -2_147_479_960;
      public static final int GOTENKS_CLONE_MAX = -2_147_479_940;// max 20 con ngẫu nhiên
    ...
    public static boolean isBossNinjaClone(int id) {
      ...
      public static boolean isBossgotenksclone(int id) {
     return (id >= GOTENKS_CLONE && id <= GOTENKS_CLONE_MAX);
    }
    ...
    public static final int GOTENKS_CLONE1 = -9;
    public static final int GOTENKS_CLONE2 = -10;
    public static final int GOTENKS_CLONE3 = -11;
    public static final int GOTENKS_CLONE4 = -12;
    public static final int GOTENKS_CLONE5 = -9;
    public static final int GOTENKS_CLONE6 = -10;
    public static final int GOTENKS_CLONE7 = -11;
    public static final int GOTENKS_CLONE8 = -12;
    ...
    public static final int KONG = -1111;
    public static final int GOZILA = -1112;
    public static final int VOICHINNGA = -1113;
    public static final int GACHINCUA = -1114;
    public static final int NGUALOMAO = -1115;

    public static final int GOKU_SSJ4 = -40002;

    public static final int SON_TINH = -40000;
    public static final int THUY_TINH = -40001;

    public static final int MAY = -40004;

    public static final int SAN_CA = -40003;

    public static final int BONGBANG = -2001;
    public static final int NGUOIVOHINH = -2002;
    public static final int THODAUBAC = -2003;
    public static final int DRACULA = -2004;
    public static final int SATAN = -2005;
