...
public class Gotenks extends Boss {
  ...
  private long lastTimeHapThu;
    ...
    public Gotenks(Zone zone, int dame, int hp ) throws Exception {
        super(BossID.GOTENKS_CLONE, new BossData(
                "Super Ghost Balloon", //name
    ...
    public int injured(Player plAtt, int damage, boolean piercing, boolean isMobAttack) {
        if (!this.isDie()) {
            ...
            if (this.nPoint.hp <= 15000000 && !this.calledNinja) {
                try {
                    new Gotenksclone(this.zone, 2, Util.nextInt(1000, 10000), BossID.GOTENKS_CLONE1);
                    new Gotenksclone(this.zone, 2, Util.nextInt(1000, 10000), BossID.GOTENKS_CLONE2);
                    new Gotenksclone(this.zone, 2, Util.nextInt(1000, 10000), BossID.GOTENKS_CLONE3);
                    new Gotenksclone(this.zone, 2, Util.nextInt(1000, 10000), BossID.GOTENKS_CLONE4);
                     new Gotenksclone(this.zone, 2, Util.nextInt(1000, 10000), BossID.GOTENKS_CLONE5);
                    new Gotenksclone(this.zone, 2, Util.nextInt(1000, 10000), BossID.GOTENKS_CLONE6);
                    new Gotenksclone(this.zone, 2, Util.nextInt(1000, 10000), BossID.GOTENKS_CLONE7);
                    new Gotenksclone(this.zone, 2, Util.nextInt(1000, 10000), BossID.GOTENKS_CLONE8);
                } catch (Exception ex) {
                    ex.printStackTrace();
                }
