...
public class ConstNpc {
    public static final String HUONG_DAN_MAP_SATAN = "Mỗi ngày từ 21h đến 23h tại thành phố Satan sẽ xảy ra 1 cuộc đại chiến\n"
    ...
    public static final byte chichi = 89; //562
    ...
    public static final byte CHU_VIT = 76;
    ...
    public static final byte GAPTHU = 79;
    public static final byte TUTIEN = 81;
    public static final byte DUAHAU = 82;
    public static final byte OBITO = 83;
    public static final byte ITACHI = 84;
    public static final byte BKT = 85;
    public static final byte BAIBIEN = 86;
    public static final byte XEMIA = 87;
     public static final byte NGHIADIA = 88;
    ...
    public static final int GOIBOT = 547720;
    ...
    public static int RUONG_PHU = 561;
    public static int NapTichLuy = 562;
    public static int ADMIN1 = 201023;
    public static int BUFFITEMM = 201024;
    public static final int CHUC_NANG_BANG_HOI = 201025;
    public static final int CHUC_NANG_BANG_HOI2 = 201026;
    ...
    public static final int TVMAX = 201027;
    public static final int MENU_PLAYER = 5239;
    public static final int BktTruytim = 532;
    public static final int BktNCHC = 534;
    public static final int BktDYHapthu = 533;
    public static final int CHUYEN_SINH = 535;
    public static final int DOT_PHA_THANTHU = 5233431;
    public static final int NpcThanThu = 52238;
    public static final int MENU_TRIEUHOI = 536;
    public static final int menu_detu = 537;
    public static final int QUANLYTK = 538;
    public static final int ACTIVE = 539;
    public static final int NEXTNV = 540;
    public static final int MAKEADMIN = 541;
}
