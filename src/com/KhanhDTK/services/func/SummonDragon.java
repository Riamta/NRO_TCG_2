...
public class SummonDragon {
    ...
    public void shenronLeave(Player pl, byte type) {
        if (type == WISHED) {
            NpcService.gI().createTutorial(pl, -1, "Điều ước của cư dân đã trở thành sự thật\nHẹn gặp cư dân lần sau, vy đi ngủ đây, bái bai");
        } else {
            NpcService.gI().createMenuRongThieng(pl, ConstNpc.IGNORE_MENU, "Vy buồn ngủ quá rồi\nHẹn gặp cư dân lần sau, Vy đi đây, bái bai");
        }
