...
import static com.KhanhDTK.models.item.ItemTime.*;
...
import static com.KhanhDTK.models.map.gas.Gas.KHI_GAS;
...
public class ItemTimeService {
    ...
    public void sendAllItemTime(Player player) {
        ...
        if (player.itemTime.isbkt) {
            sendItemTime(player, 5829, (int) ((TIME_MAY_DO - (System.currentTimeMillis() - player.itemTime.lastbkt)) / 1000));
        }        
        if (player.itemTime.isUseCuongNo) {
         ...
         if (player.itemTime.isUsekeo) {
            sendItemTime(player, 11749, (int) ((TIME_ITEM - (System.currentTimeMillis() - player.itemTime.lastTimekeo)) / 1000));
        }
          if (player.itemTime.isUsemat) {
            sendItemTime(player, 8243, (int) ((TIME_ITEM - (System.currentTimeMillis() - player.itemTime.lastTimemat)) / 1000));
        }
           if (player.itemTime.isUsegato) {
            sendItemTime(player, 8246, (int) ((TIME_ITEM - (System.currentTimeMillis() - player.itemTime.lastTimemat)) / 1000));
        }
            if (player.itemTime.isUseber) {
            sendItemTime(player, 8247, (int) ((TIME_ITEM - (System.currentTimeMillis() - player.itemTime.lastTimeber)) / 1000));
        }
             if (player.itemTime.isUsesup) {
            sendItemTime(player, 8244, (int) ((TIME_ITEM - (System.currentTimeMillis() - player.itemTime.lastTimesup)) / 1000));
        }
        ...
        if (player.itemTime.isdkhi) {
            sendItemTime(player, 16045, (int) ((TIME_DUOI_KHI - (System.currentTimeMillis() - player.itemTime.lastTimedkhi)) / 1000));
        }
    }
