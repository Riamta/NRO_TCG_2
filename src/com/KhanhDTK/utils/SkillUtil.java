...
import com.KhanhDTK.models.skill.SkillNotFocus;
...
//        return 10000;
    ...
    public static byte getTempSkillSkillByItemID(int id) {
        ...
        } else if (id >= 1417 && id <= 1423) {
            return Skill.SUPER_KAME;
        } else if (id >= 1424 && id <= 1430) {
            return Skill.LIEN_HOAN_CHUONG;
        } else if (id >= 1431 && id <= 1437) {
            return Skill.MA_PHONG_BA;
        } else if (id >= 1692 && id <= 1697) {
            return Skill.SUPER_TRANFORMATION;
        } else if (id >= 1698 && id <= 1703) {
            return Skill.SUPER_TRANFORMATION;
        } else if (id >= 1704 && id <= 1709) {
            return Skill.SUPER_TRANFORMATION;
        } else if (id == 1710) {
            return Skill.EVOLUTION;
             
        } else if (id >= 1734 && id <= 1740) {
             return Skill.PHAN_THAN;
             } else if (id >= 1741 && id <= 1747) {
             return Skill.PHAN_THAN;
             } else if (id >= 1748 && id <= 1754) {
             return Skill.PHAN_THAN;
        } else {
            return -1;
        }
    ...
    public static Skill getSkillByItemID(Player pl, int tempId) {
        ...
        } else if (tempId >= 1417 && tempId <= 1423) {
            return getSkillbyId(pl, Skill.SUPER_KAME);
        } else if (tempId >= 1424 && tempId <= 1430) {
            return getSkillbyId(pl, Skill.LIEN_HOAN_CHUONG);
        } else if (tempId >= 1431 && tempId <= 1437) {
            return getSkillbyId(pl, Skill.MA_PHONG_BA);
        } else if (tempId >= 1692 && tempId <= 1697) {
            return getSkillbyId(pl, Skill.SUPER_TRANFORMATION);
        } else if (tempId >= 1698 && tempId <= 1703) {
            return getSkillbyId(pl, Skill.SUPER_TRANFORMATION);
        } else if (tempId >= 1704 && tempId <= 1709) {
            return getSkillbyId(pl, Skill.SUPER_TRANFORMATION);
        } else if (tempId == 1710) {
            return getSkillbyId(pl, Skill.EVOLUTION);
            } else if (tempId >= 1734 && tempId <= 1740) {
            return getSkillbyId(pl, Skill.PHAN_THAN);
             } else if (tempId >= 1741 && tempId <= 1747) {
            return getSkillbyId(pl, Skill.PHAN_THAN);
             } else if (tempId >= 1748 && tempId <= 1754) {
            return getSkillbyId(pl, Skill.PHAN_THAN);
        } else {
            return null;
        }
