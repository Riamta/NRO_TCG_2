...
import com.KhanhDTK.consts.ConstIgnoreName;
...
import com.KhanhDTK.services.func.LuckyRound;
...
//                            }
//                            if (type1 == 2) {
//                                OnlineHangNgay.GetArchivemnt(player, index);
//                            }
//                            if (type1 == 3) {
//                                QuaNapHangNgay.GetArchivemnt(player, index);
//                            }
//                        } else {
//                            Service.gI().sendThongBao(player, "Vui lòng sử dụng phiên bản mới nhất từ trang chủ");
//                        }
//                    }
//                    break;
                case -32:
...
//                                Service.gI().sendThongBao(player, "Đang bảo trì...");
    ...
    private void sendThongBaoServer(Player player) {
        Service.gI().sendThongBaoFromAdmin(player, "|4|"
                + "Chào Mừng " + player.name + " Đến Với Ngọc Rồng Alone\n"
                + "Bạn Đã Offline Được: " + player.timeoff + " Phút\n"
    ...
    public void sendInfo(MySession session) {
        ...
        if (TaskService.gI().getIdTask(player) == ConstTask.TASK_0_0) {
            NpcService.gI().createTutorial(player, -1,
                    "Chào mừng " + player.name + " đến với Máy Chủ Ngọc rồng KhanhDTK\n"
        ...
        if (player.vip >= 1 && player.vip < 4) {
            ServerNotify.gI().notify("Người chơi: " + player.name + ", VIP: "
                    + player.vip + " Đã vào game");
